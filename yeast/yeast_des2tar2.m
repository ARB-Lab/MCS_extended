% This script reproduces the results from S5 Table, Sheet S. cerevisiae, scenario 4. 
%
...
% acetate and/or glycerol with S. cerevisiae. Compared to the third scenario, a 
...
% T1: Under all circumstances the 2,3 BDO / glc yiled should exceed
%     the yield threshold
T1 = full(sparse( [1         1           ], ...
                  [r23BDO_ex rGlc_up     ], ...
                  [4         6*Y_thresh	 ],1,cnap.numr));
t1 =  0;
% T2: If Acetate is not secreted, the 2,3 BDO / glc+ac yiled should exceed
%     the yield threshold
